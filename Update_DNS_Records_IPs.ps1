...
$RecordSet = Get-AzPrivateDnsRecordSet -ResourceGroupName $private_DNS_Zone_resource_group_name -ZoneName $zone_name -Name $record_name -RecordType A
...
$RecordSet = Get-AzPrivateDnsRecordSet -Name $record_name -RecordType A -ResourceGroupName $private_DNS_Zone_resource_group_name -ZoneName $zone_name
